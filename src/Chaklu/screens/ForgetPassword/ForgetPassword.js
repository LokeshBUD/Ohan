...
const Forget = () => {
  ...
  return (
    <View style={styles.root}>
      ...
      <CustomInput placeholder="New Password"  placeholderTextColor="#707070" value={Password} setValue={setPassword} secureTextEntry={true}></CustomInput>
      ...
      <CustomButton text="Confirm" placeholderTextColor="#707070" onPress={onRegisterPressed}></CustomButton>
